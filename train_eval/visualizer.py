...
class Visualizer:
    ...
    """
    def __init__(self, cfg: Dict, data_root: str, data_dir: str, checkpoint_path: str, example: int, tf: int = 12, num_modes: int = 10):
        """
        ...
        self.show_predictions = True # To visualize baseline with only gt 
    ...
    def visualize_nuscenes(self, output_dir):
        ...
        for n, indices in enumerate(index_list):
            ...
            filename = os.path.join(output_dir, 'example' + str(n) + scene  + '.gif')
